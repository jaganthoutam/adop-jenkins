...
- [`0.2.0`, `0.2.0` (*0.2.0/Dockerfile*)](https://github.com/jaganthoutam/adop-jenkins/blob/master/Dockerfile)
...
```
docker run --name <your-container-name> -d -p 8080:8080 jaganthoutam/adop-jenkins:VERSION
```
